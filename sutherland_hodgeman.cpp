...
/*int gdriver=DETECT,gmode;
    ...
    if(i==poly_size-1)
        line(poly_points[i][0],poly_points[i][1],poly_points[0][0],poly_points[0][1]);
     else
...
int main()
{
    ...
    int poly_size = 4;
    int poly_points[20][2] = {{50,150}, {150,50},
                              {250,150},{150,250}};
    // Defining clipper polygon vertices in clockwise order
    // 1st Example with square clipper
    int clipper_size = 4;
    int clipper_points[][2] = {{100,100}, {200,100},
                              {200,200}, {100,200} };
